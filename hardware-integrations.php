...
<div id="story-2">
    <div class="row">
        <div class="small-12 large-6 columns">
            ...
            <img src="img/hardware/alex_mobile_2.png" alt="">
    ...
    <div class="row">
        <div class="small-12 columns">
            <img src="img/hardware/david_mobile.png" alt="" class="hide-for-large-up">
            <img src="img/hardware/david_desktop.png" alt="" class="show-for-large-up">
        </div>
    </div>
</div>
<div id="story-3">
...
<div id="all-in-one">
    <div class="row">
        <div class="small-12 large-6 columns">
            <h2>The all-in-one Communications Solution</h2>
