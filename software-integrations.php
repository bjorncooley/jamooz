...
<div id="software-integrations">
    ...
    <div id="software-intro">
        <div class="row">
            <div class="large-12 columns">
                <h3>Software integrations can be like Cable TV. So much to choose from,
                yet all have distracting commercials. We curate software integrations
                that have been proven to work for our customers. See how they use it.</h3>
            </div>
        </div>
    </div>
    ...
    <div id="software-trial" class="light-gray-background padding-bottom-50 padding-top-15">
        <div class="row">
