...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <div id="hero">
            ...
            <div class="row">
                <div class="large-12 columns text-center">
                    <button class="teal-background uppercase radius width-100-percent max-275">Get Started for 30 Days Free</button>
                    <h6 class="small-9 columns small small-centered">a customer success teammate is ready to help</h6>
                    <img src="img/shared/down_arrow_black.png" alt="" class="padding-top-15 padding-bottom-30 pointer" id="hero-down-arrow">
                </div>
            </div>
        </div><!-- #hero -->
        <div id="intro">
        ...
        <div class="medium-blue-background" id="trial">
            ...
            <div class="row">
                <form action="">
                    ...
                    <div class="row">
                        <div class="large-12 columns text-center">
                            <button class="red-orange-background radius width-100-percent max-285 uppercase">Get Started For 30 Days Free</button>
                            <div class="row">
            ...
            <div class="row text-center">
                <button class="red-orange-background small-10 large-4 radius-7 padding-15">
                    ...
                    <div class="show-for-medium-up">
                        <div class="uppercase normal">Need Support? Contact Us Here</div>
                    </div>
                </button>
            </div>
            <div class="row text-center">
        ...
        <div class="dark-gray-background white" id="footer">
            <div class="container">
                <div class="row">
                    <div class="large-12 columns text-center hide-for-large-up">
                ...
                <div class="row">
                    ...
                    <div class="show-for-large-up large-4 columns text-center">
                        <img src="img/shared/jamooz_logo_white.png" alt="">
                    </div>
                    <div class="small-12 large-4 columns small-centered large-uncentered">
                        <div class="row">
